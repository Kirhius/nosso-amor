...
export const GET = rota(async () => resposta({ eventos: await listarEventos() }))
...
export const POST = rota(async (req: Request) => {
  ...
  const q = await db()
  await q`INSERT INTO eventos (titulo, tipo, data, observacao) VALUES (${titulo}, ${tipo}, ${data}, ${observacao})`
